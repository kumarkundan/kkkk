...
public class ManagerReceivedLTab extends Fragment {
     ...
     */
    private ReceivedItemAdapterLTab mAdapter;
   ...
   // Button to,from;
    ...
    private void refreshItemsFromTable(final View v) {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            LinearLayout linlaHeaderProgress = (LinearLayout) v.findViewById(R.id.linlaHeaderProgressltab);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.activity_manager_received_ltab,container,false);
        try {
            ...
            mAdapter = new ReceivedItemAdapterLTab(getActivity(), R.layout.row_employeelistltab);
            ListView listViewToDo = (ListView) v.findViewById(R.id.listViewRecievedLTab);
