 ...
 */
public class ViewPagerAdapterSTab extends FragmentStatePagerAdapter {
    ...
    public ViewPagerAdapterSTab(FragmentManager fm, CharSequence mTitles[], int mNumbOfTabsumb) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        {
            ManagerReceivedSTab tab1 = new ManagerReceivedSTab();
            return tab1;
        }
        else  if(position==1)            // As we are having 2 tabs if the position is now 0 it must be 1 so we are returning second tab
        {
            ManagerSentSTab tab2 = new ManagerSentSTab ();
            return tab2;
        }
        else {

            ManagerTweetsSTab tab3=new ManagerTweetsSTab();
            return tab3;
        }
