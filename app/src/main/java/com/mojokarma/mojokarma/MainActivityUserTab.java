...
public class MainActivityUserTab extends ActionBarActivity {

    Toolbar toolbar;
    ViewPager pager;
    ViewPagerAdapterUserTab adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ViewPagerAdapterUserTab(getSupportFragmentManager(), Titles, Numboftabs);
