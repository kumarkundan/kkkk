...
public class ManagerSentSTab extends Fragment {
     ...
     */
    private SentItemAdapterSTab mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.activity_manager_sent_stab,container,false);
        try {
            ...
            mAdapter = new SentItemAdapterSTab(getActivity(), R.layout.row_employeeliststab);
            ListView listViewToDo = (ListView) v.findViewById(R.id.listViewSentSTab);
