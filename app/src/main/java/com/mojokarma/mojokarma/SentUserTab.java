...
public class SentUserTab extends Fragment {
    /**
     ...
     */
    private SentItemAdapterUserTab mAdapter;
    ...
    private void refreshItemsFromTable(final View v) {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            LinearLayout linlaHeaderProgress = (LinearLayout) v.findViewById(R.id.linlaHeaderProgresssent);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.activity_sent_usertab,container,false);
        try {
            ...
            mAdapter = new SentItemAdapterUserTab(getActivity(), R.layout.tab_row_list);
            ListView listViewToDo = (ListView) v.findViewById(R.id.listViewSent);
