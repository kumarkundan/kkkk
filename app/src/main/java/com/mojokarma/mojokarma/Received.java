...
public class Received extends ActionBarActivity {
     ...
     */
    private RecievedItemAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Globals gb = (Globals) getApplicationContext();
        ...
        try {
            ...
            mAdapter = new RecievedItemAdapter(this, R.layout.tab_row_list);
            ListView listViewToDo = (ListView) findViewById(R.id.listViewRecieved);
    ...
    private void refreshItemsFromTable() {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            LinearLayout linlaHeaderProgress = (LinearLayout) findViewById(R.id.linlaHeaderProgressrecievd);
