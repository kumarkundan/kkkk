...
public class RecievedItemAdapterSTab extends ArrayAdapter<User> {
    ...
    public RecievedItemAdapterSTab(Context context, int layoutResourceId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final TextView designation = (TextView) row.findViewById(R.id.desigstab);

        //Log.v("Here ISSSSSSSSSSSSSSS",currentItem.getDesignation());
        designation.setText(currentItem.getDesignation());


        final TextView txt= (TextView) row.findViewById(R.id.stabreccount);
        ...
        try {
            ...
            new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... params) {
                    try {
                        result[0] =
                                mUser.where().field("to").eq(currentItem.getContent()).execute().get().getTotalCount();
