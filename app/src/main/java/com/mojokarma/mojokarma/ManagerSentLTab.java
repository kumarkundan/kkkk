...
public class ManagerSentLTab extends Fragment {
     ...
     */
    private SentItemAdapterLTab mAdapter;
    ...
    private void refreshItemsFromTable(final View v) {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            LinearLayout linlaHeaderProgress = (LinearLayout) v.findViewById(R.id.linlaHeaderProgresssentltab);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.activity_manager__sent_ltab,container,false);
        try {
            ...
            mAdapter = new SentItemAdapterLTab(getActivity(), R.layout.row_employeelistltab);
            ListView listViewToDo = (ListView) v.findViewById(R.id.listViewSentLTab);
