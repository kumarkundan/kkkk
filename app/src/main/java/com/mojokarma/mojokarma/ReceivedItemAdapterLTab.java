...
public class ReceivedItemAdapterLTab extends ArrayAdapter<User> {
     ...
     * Adapter View layout
     */
    private int mrLayoutResourceId;

    private LayoutInflater mrInflater;
    public ReceivedItemAdapterLTab(Context context, int layoutResourceId) {
